...
#ifndef _Included_org_hystudio_android_dosbox_DOSBoxSettings_Render
#define _Included_org_hystudio_android_dosbox_DOSBoxSettings_Render
#ifdef __cplusplus
extern "C" {
#endif
...
JNIEXPORT int JNICALL Java_org_hystudio_android_dosbox_DOSBoxSettings_nativeGetFrameskip
  (JNIEnv *, jclass) {
