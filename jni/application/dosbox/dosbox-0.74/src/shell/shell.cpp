...
#ifndef _Included_org_hystudio_android_dosbox_DOSBoxSettings_Shell
#define _Included_org_hystudio_android_dosbox_DOSBoxSettings_Shell
#ifdef __cplusplus
extern "C" {
#endif

JNIEXPORT void JNICALL Java_org_hystudio_android_dosbox_DOSBoxSettings_nativeDOSExit
  (JNIEnv *, jclass) {
