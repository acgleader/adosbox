...
JNIEXPORT int JNICALL Java_org_hystudio_android_dosbox_DOSBoxSettings_nativeGetCPUCycle
  (JNIEnv *, jclass) {
  return CPU_CycleMax;
}

JNIEXPORT int JNICALL Java_org_hystudio_android_dosbox_DOSBoxSettings_nativeGetCPUCycleUp
  (JNIEnv *, jclass) {
  return CPU_CycleUp;
}

JNIEXPORT int JNICALL Java_org_hystudio_android_dosbox_DOSBoxSettings_nativeGetCPUCycleDown
  (JNIEnv *, jclass) {
  return CPU_CycleDown;
}
