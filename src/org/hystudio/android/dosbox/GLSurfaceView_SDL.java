 ...
 * 
 */
public class GLSurfaceView_SDL extends SurfaceView implements
	...
	private class EglHelper {
		...
		public void start() {
			...
			Log.v("SDL",
					"GLSurfaceView_SDL::EglHelper::start(): creating GL context");
			/*
			 * Get an EGL instance
			 */
		...
		public GL createSurface(SurfaceHolder holder) {
			Log.v("SDL",
					"GLSurfaceView_SDL::EglHelper::createSurface(): creating GL context");
			/*
		...
		public void finish() {
			Log.v("SDL",
					"GLSurfaceView_SDL::EglHelper::finish(): destroying GL context");
			if (mEglSurface != null) {
				mEgl.eglMakeCurrent(mEglDisplay, EGL10.EGL_NO_SURFACE,
						EGL10.EGL_NO_SURFACE, EGL10.EGL_NO_CONTEXT);
				mEgl.eglDestroySurface(mEglDisplay, mEglSurface);
